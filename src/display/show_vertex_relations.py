...
if __name__ == "__main__":
    ...
    stress_lines = vertex_relations.stress_line_collection(
        vertices, colors="blue", linewidths=1
    )
    shear_lines = vertex_relations.shear_line_collection(
        vertices, colors="red", linewidths=1
    )
