...
STRESS_WEIGHTING = 500  # Weight to apply to the stress force
STRESS_THRESHOLD = 0.05  # Percentage of resting distance where stress starts applying
SHEAR_WEIGHTING = 250  # Weight to apply to the shear force
...
DISTANCE_FROM_BODY = 0.05  # Default distance along normal of alignment point on avatar
