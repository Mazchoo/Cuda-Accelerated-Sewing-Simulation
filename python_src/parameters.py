...
STRESS_THRESHOLD = 0.01  # Percentage of resting distance where stress starts applying
SHEAR_WEIGHTING = 100  # Weight to apply to the shear force
SHEAR_THRESHOLD = 0.01  # Percentage of resting distance where shear starts applying
CM_PER_M = 100  # Scale of coordinates in clothing to world coordinates
FRICTION_CONSTANT = 0.5  # Constant of velocity resisting acceleration
